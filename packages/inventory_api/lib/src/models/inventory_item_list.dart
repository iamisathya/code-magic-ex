...
part 'inventory_item_list.g.dart';

@JsonSerializable()
class InventoryItemListModel {
  @JsonKey(name: "items")
  List<InventoryItemListModel>? items;

  InventoryItemListModel({this.items});

  factory InventoryItemListModel.fromJson(Map<String, dynamic> json) =>
      _$InventoryItemListModelFromJson(json);

  Map<String, dynamic> toJson() => _$InventoryItemListModelToJson(this);
}
