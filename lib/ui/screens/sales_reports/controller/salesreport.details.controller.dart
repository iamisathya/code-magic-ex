...
class SalesReportDetailsController extends GetxController {
  ...
  Future<void> getOpenPlaceOrderDetails2() async {
    ...
    try {
      barcodeDetails =
          await MemberCallsService.init().getBarcodeDetails(gToken, "423182123", "b5eb37c5-5644-492d-b703-817cf58bfa9e", "31512d2a1d4a2a5860bc785d27d1f7522ad2ddc6de4667f07aa6ac036f67662c");
