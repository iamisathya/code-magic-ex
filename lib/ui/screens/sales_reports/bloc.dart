...
class SalesReportBloc {
  ...
  Future<void> loadSalesReports() async {
    ...
    try {
      final OrdersAndRmas ordersAndRMAs = await ApiService.clientNoLogger().getOrdersAndRmas("9e41f330617aa2801b45620f8ffc5615306328fa0bd2255b0d42d7746560d24c", "[2021-06-01;2021-06-15]", "order,rma");
      print(ordersAndRMAs);
