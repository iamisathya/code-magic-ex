...
BarCodeItemsResponse _$BarCodeItemsResponseFromJson(Map<String, dynamic> json) {
  return BarCodeItemsResponse(
...
BarcodeItem _$BarcodeItemFromJson(Map<String, dynamic> json) {
  return BarcodeItem(
