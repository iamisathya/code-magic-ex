...
EnrolmentPaymentMethods _$EnrolmentPaymentMethodsFromJson(Map json) {
  return EnrolmentPaymentMethods(
...
Markets _$MarketsFromJson(Map json) {
  return Markets(
    countryCode: json['countryCode'] as String,
    paymentModes: (json['paymentModes'] as List<dynamic>)
        .map((e) => PaymentModes.fromJson(Map<String, dynamic>.from(e as Map)))
        .toList(),
  );
}
...
PaymentModes _$PaymentModesFromJson(Map json) {
  return PaymentModes(
    ...
    details: (json['details'] as List<dynamic>?)
        ?.map(
            (e) => NameValuePairs.fromJson(Map<String, dynamic>.from(e as Map)))
        .toList(),
  );
}
...
NameValuePairs _$NameValuePairsFromJson(Map json) {
