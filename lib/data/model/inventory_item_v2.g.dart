...
part of 'inventory_item_v2.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

InventoryItemV2 _$InventoryItemV2FromJson(Map<String, dynamic> json) =>
    InventoryItemV2(
...
Map<String, dynamic> _$InventoryItemV2ToJson(InventoryItemV2 instance) =>
    <String, dynamic>{
...
ItemInfo _$ItemInfoFromJson(Map<String, dynamic> json) => ItemInfo(
      ...
      itemInfoList: json['item_info_list'] == null
          ? null
          : ItemInfoList.fromJson(
              json['item_info_list'] as Map<String, dynamic>),
      itemInfoLinkTarget: json['item_info_link_target'] as String?,
      itemInfoLinkUrl: json['item_info_link_url'] == null
          ? null
          : ItemName.fromJson(
              json['item_info_link_url'] as Map<String, dynamic>),
