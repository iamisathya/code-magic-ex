...
class _ApiService implements ApiService {
  ...
  @override
  Future<PasswordUpdateModel> updatePassword(data) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PasswordUpdateModel>(
            Options(method: 'POST', headers: _headers, extra: _extra)
                .compose(_dio.options, '/customers/me/password',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = PasswordUpdateModel.fromJson(_result.data!);
    return value;
  }

  @override
  Future<ProfilePicture> updateProfilePicture(media) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ProfilePicture>(Options(
                method: 'POST',
                headers: _headers,
                extra: _extra,
                contentType: 'multipart/form-data')
            .compose(_dio.options, '/customers/me/profilePicture',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<dynamic> sendPasswordResetLink(data) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio.fetch(_setStreamType<dynamic>(
        Options(method: 'POST', headers: _headers, extra: _extra)
            .compose(_dio.options, '/passwordresettokens',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  get onDelete => throw UnimplementedError();
  ...
  get onStart => throw UnimplementedError();
}
...
class _MemberCallsService implements MemberCallsService {
  ...
  Future<List<InventoryRecordsMatchedItem>> getOutOfStockInventoryRecords(
      type, token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'type': type, r'token': token};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<InventoryRecordsMatchedItem>>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'ALL/DSC/THA/getdata.php',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    var value = _result.data!
        .map((dynamic i) =>
            InventoryRecordsMatchedItem.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<BarcodeResponse> getBarcodeDetails(cookie, order, token, href) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BarcodeResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'ALL/DSC/THA/barcode/redirect.php',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
...
class _MemberCalls2Service implements MemberCalls2Service {
  ...
  Future<CashCouponResponse> getCashCoupon(pv, id) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CashCouponResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(
                    _dio.options, 'unishop-fn-misc/cashcoupon_quota//${id}',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<CompleteAddressResponse> getAddressByZipcode(type, keyword) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'country_code': type,
      r'keyword': keyword
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CompleteAddressResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'unishop-fn-misc/city/search',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = CompleteAddressResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<HydraProducts> getHydraProducts(countryId, status, allow) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'status': status,
      r'allow': allow
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HydraProducts>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'products-v2/publish/${countryId}',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = HydraProducts.fromJson(_result.data!);
    return value;
  }

  @override
  Future<InventoryItemV2> loadInventoryProductsV2(
      warehouseId, expand, countryCode) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'expand': expand,
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<InventoryItemV2>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options,
                    'products-v2/adapter/${warehouseId}/inventoryRecords',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = InventoryItemV2.fromJson(_result.data!);
    return value;
  }
